...
weeks where you already know one of the answers — leftovers night, takeout, a
recipe you want to try. Type a name and anything you need to buy, and it lands in
this week's hand **and in your deck**, so it can be dealt again later. Write-ins
count as one of your meals rather than an extra, so a five-meal week with one
write-in deals four, and they arrive locked so re-dealing keeps them. A name that
already exists in the deck is reused rather than duplicated.

A written meal starts on neutral defaults — *Easy*, health 60, four stars — since
the deal needs those to weight it. Tune them on the Deck tab whenever you like.
